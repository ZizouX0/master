...
| **`SOUND-and-SCHOLARSHIPS.xlsx`** | 25 tabs | **Only the sound side, plus every scholarship.** 537 programmes — sound design/production (269), audio engineering (225), music tech (43) — with the 335 music-business and 193 adjacent rows removed. Tabs: *★ Best bets (78) · one per track · No portfolio needed (63) · Fully funded (73) · Sound + a scholarship · All scholarships (335) · Scholarship index (308 schemes) ·* one per country | You want the sound options and the funding in one place, without the business noise |
