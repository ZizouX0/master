# 🎓 Master's & Scholarship Search — Results

> **➡️ Everything is in [`results/`](./results). Start with
> [`THE-COMPLETE-GUIDE.md`](./results/THE-COMPLETE-GUIDE.md), then open
> [`MASTER-all-opportunities.xlsx`](./results/MASTER-all-opportunities.xlsx).**

> ℹ️ **Click the `.md` links to read straight here on GitHub** — GitHub renders Markdown but
> cannot preview PDFs or spreadsheets, so those show an "unable to render" message. The **PDF**
> links are for downloading, printing and reading offline; the content is identical.

An exhaustive, source-verified search of master's programmes and scholarships for a **Tunisian
...
## 🔵 The three regional deep dives

| File | What it is |
|---|---|
| 🇪🇺 **[EUROPE-GAPFILL.md](./results/EUROPE-GAPFILL.md)** *(reads here)* · [PDF](./results/pdf/EUROPE-GAPFILL.pdf) · [xlsx](./results/europe-gapfill.xlsx) | **104 institutions the earlier searches missed**, 26 countries, searched in every local language. Holds your two best-rated options — **TU Ilmenau** and **HfK Bremen**. Documents that most German states charge non-EU students **no tuition at all** |
| ⚠️ **[PRIVATE-SCHOOLS.md](./results/PRIVATE-SCHOOLS.md)** *(reads here)* · [PDF](./results/pdf/PRIVATE-SCHOOLS.pdf) · [xlsx](./results/private-schools-es-pt-nl-it.xlsx) | **The "don't get scammed" file.** 198 private institutions in Spain, Portugal, Netherlands and Italy, accreditation checked first — which "Masters" are **not degrees**, why the Netherlands is closed to you, and the **Italian DSU scholarship** worth €5,776–€8,134/yr |
| 🎚️ **[SOUND-DESIGN-EUROPE.md](./results/SOUND-DESIGN-EUROPE.md)** *(reads here)* · [PDF](./results/pdf/SOUND-DESIGN-EUROPE.pdf) · [xlsx](./results/sound-design-europe.xlsx) | **319 programmes** in your core subject across every European country — conservatoires, film schools, private academies. The A-list of 13 |
...
*Full method, per-country detail and the honest limits are in
[`results/THE-COMPLETE-GUIDE.md`](./results/THE-COMPLETE-GUIDE.md).*
